...
module.exports = {
    ...
    execute(msg, args, discord) {
        ...
        chanToJoin.join().then(connection => {
            let song = chooseFile('./files/audio', args[0])
...
/**
 * choose a random audio to reproduce
 * @param {*} path Audio folder
 * @param {*} categ Pool to choose from
 * @returns directory of the audio to play
 */
function chooseFile(path, categ){
